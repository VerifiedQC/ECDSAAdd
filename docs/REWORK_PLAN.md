...
## 23. D1：受控常数点加的求逆工作区复用（设计，待证明）

Owner 已批准继续设计及其后实现；本节为 task #50 的 Q2/Q3/Q4 联合设计。当前已证值仍是 8,946,186 Toffoli / 5,772,554 测量 / 6,218 线。D1 不依赖 D2 的一位记录，不把 Q1 的512线收益计入交付。
