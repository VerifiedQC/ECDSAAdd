...
## 23. D1：受控常数点加的求逆工作区复用（3a已实现，外层P待3b）

Owner 已批准继续设计及其后实现；本节为 task #50 的 Q2/Q3/Q4 联合设计。设计基线为 8,946,186 Toffoli / 5,772,554 测量 / 6,218 线；3a已证当前值为8,918,440 / 5,750,952 / 5,731，外层P待3b。D1 不依赖 D2 的一位记录，不把 Q1 的512线收益计入交付。
