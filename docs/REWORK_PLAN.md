...
## 29. 改12 A：Kaliski值走与原地乘除接入（设计，未实现）

基线main `0ea3933c`：点加8,813,634 Toffoli /5,646,146测量 /3,939实际支持线，K2平方275,129 T/M。task #58，配套回放格见§30。以下新数均为拟定门列预算，不是已证资源；不改变当前README值、公开规格或公理块。
