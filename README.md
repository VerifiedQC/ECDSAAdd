...
| 改 3（数学已证） | 除法中心原地更新：2 次除法内含 2 个乘积，另加 3 个乘积；输出侧标志清理 | 14,998,618（待证明） | 6,218 实际支持（待证明） | Deutsch |
...
改3的八个数学引理已证明，见[证明状态](docs/PROOF_STATUS.md#改-3-数学原地更新与输出侧清理条件)：涵盖输出侧标志、普通分支域等式和第二除数为零时的例外斜率。除法与新的原地点加电路仍待实现，资源目标未替换当前已证值。
