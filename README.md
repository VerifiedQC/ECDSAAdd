...
改 5 的具体设计见 [§15](docs/REWORK_PLAN.md#15-改-5-实施设计测量清零检测与原地受控加减待复审未实现)：仅替换当前 Kaliski 零检测和受控加减时，单轮目标为3,629 Toffoli，完整受控点加目标52,917,045；尚未实现，不包含改2/3收益，也不替换上面的Current status。
