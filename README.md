...
改 6b 已立项，设计账本见 [REWORK_PLAN §18](docs/REWORK_PLAN.md#18-改-6b全-montgomery-表示与边界成本设计待复审)。编码接口核心目标11,339,178 Toffoli；保留普通坐标的保守边界包装反而增至12,076,586，均待复审、未实现，当前已证值不变。
