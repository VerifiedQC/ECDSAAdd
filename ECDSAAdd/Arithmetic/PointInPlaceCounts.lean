...
theorem pointInPlaceGeneric_counts (L : ControlledPointLayout) (hw : L.Widths)
    ...
    toffoliCount (pointInPlaceGeneric L cx cy lambdaStar)=10998260 ∧
    measurementCount (pointInPlaceGeneric L cx cy lambdaStar)=5190900 := by
...
theorem pointInPlaceFinite_counts (L : ControlledPointLayout) (hw : L.Widths)
    ...
    toffoliCount (pointInPlaceFinite L C cx cy)=11001338 ∧
    measurementCount (pointInPlaceFinite L C cx cy)=5193978 := by
