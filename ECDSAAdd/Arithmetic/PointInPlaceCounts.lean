...
theorem pointInPlaceGeneric_counts (L : ControlledPointLayout) (hw : L.Widths)
    ...
    toffoliCount (pointInPlaceGeneric L cx cy lambdaStar)=11666420 ∧
    measurementCount (pointInPlaceGeneric L cx cy lambdaStar)=4522740 := by
...
theorem pointInPlaceFinite_counts (L : ControlledPointLayout) (hw : L.Widths)
    ...
    toffoliCount (pointInPlaceFinite L C cx cy)=11669498 ∧
    measurementCount (pointInPlaceFinite L C cx cy)=4525818 := by
