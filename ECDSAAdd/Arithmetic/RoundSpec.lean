...
theorem kaliskiRound_257_resources (L : KaliskiRoundLayout) (hnd : L.wires.Nodup)
    ...
    toffoliCount (kaliskiRound L i)=3629 ∧ measurementCount (kaliskiRound L i)=1056 ∧
    qubitCount (kaliskiRound L i)=1847 ∧
    toffoliCount (kaliskiUnround L i)=3629 ∧ measurementCount (kaliskiUnround L i)=1056 ∧
