import ECDSAAdd.Arithmetic.RoundWires
...
private theorem state_iff (L : KaliskiRoundLayout) (z : KState) (K N : Nat) (D S T : Bool) (st : BasisState) :
...
theorem kaliskiRound_spec (L : KaliskiRoundLayout) (hnd : L.wires.Nodup)
  ...
  simpa only [Triple,state_iff,Holds.holds] using kaliskiRound_state L hnd hw i p a z hi hk hinv hp hu hv hr
...
theorem kaliskiUnround_spec (L : KaliskiRoundLayout) (hnd : L.wires.Nodup)
  ...
  simpa only [Triple,state_iff,Holds.holds] using kaliskiUnround_state L hnd hw i p a z hi hk hinv hp hu hv hr
...
theorem kaliskiRound_257_resources (L : KaliskiRoundLayout) (hnd : L.wires.Nodup)
    ...
    toffoliCount (kaliskiRound L i)=4669 ∧ measurementCount (kaliskiRound L i)=1582 ∧
    qubitCount (kaliskiRound L i)=2104 ∧
    toffoliCount (kaliskiUnround L i)=4669 ∧ measurementCount (kaliskiUnround L i)=1582 ∧
